package com.campus.gen.service.impl;

import cn.hutool.core.io.IoUtil;
import cn.hutool.core.util.StrUtil;
import com.baomidou.mybatisplus.core.conditions.query.LambdaQueryWrapper;
import com.baomidou.mybatisplus.extension.plugins.pagination.Page;
import com.campus.system.entity.SysMenu;
import com.campus.gen.entity.*;
import com.campus.gen.mapper.GenTableColumnMapper;
import com.campus.gen.mapper.GenTableMapper;
import com.campus.system.mapper.SysMenuMapper;
import com.campus.system.entity.SysRole;
import com.campus.system.entity.SysRoleMenu;
import com.campus.system.mapper.SysRoleMapper;
import com.campus.system.mapper.SysRoleMenuMapper;
import com.campus.gen.service.GenTableService;
...
public class GenTableServiceImpl implements GenTableService {
    ...
    public void importTable(String[] tableNames) {
        for (String tableName : tableNames) {
            ...
            table.setPackageName("com.campus.biz");
    ...
    public List<String> previewGenerateFiles(Long tableId) {
        ...
        if (projectRoot.endsWith("campus-web")) {
    ...
    public List<String> generateToProject(Long tableId) {
        ...
        // 获取项目根目录
        String projectRoot = System.getProperty("user.dir");
        // 如果是在 campus-web 目录下运行，需要找到项目根目录
        if (projectRoot.endsWith("campus-web")) {
            projectRoot = projectRoot.substring(0, projectRoot.length() - 8);
        }
    ...
    private String getProjectFilePath(GenTable table, String fileName, String projectRoot) {
        ...
        return switch (fileName) {
            case "Entity.java" -> projectRoot + "/campus-core/campus-biz/src/main/java/com/campus/biz/entity/" + className + ".java";
            case "Mapper.java" -> projectRoot + "/campus-core/campus-biz/src/main/java/com/campus/biz/mapper/" + className + "Mapper.java";
            case "Service.java" -> projectRoot + "/campus-core/campus-biz/src/main/java/com/campus/biz/service/" + className + "Service.java";
            case "ServiceImpl.java" -> projectRoot + "/campus-core/campus-biz/src/main/java/com/campus/biz/service/impl/" + className + "ServiceImpl.java";
            case "Controller.java" -> projectRoot + "/campus-core/campus-biz/src/main/java/com/campus/biz/controller/" + className + "Controller.java";
            case "api.ts" -> projectRoot + "/campus-ui/src/api/" + businessName + ".ts";
            case "index.vue" -> projectRoot + "/campus-ui/src/views/" + moduleName + "/" + businessName + "/index.vue";
