package com.campus.system.helper;
...
public class SystemConfigHelper implements com.campus.crypto.CryptoConfigProvider, com.campus.mail.MailConfigProvider {
    ...
    public String getSiteName() {
        return getString(GROUP_SYSTEM, "siteName", "campus管理系统");
    }
