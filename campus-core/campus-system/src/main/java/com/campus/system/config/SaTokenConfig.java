        ...
        registry.addInterceptor(new SaInterceptor(handler -> {
            ...
            SaRouter.match("/api/**")
                    .notMatch(
                            ...
                            "/api/app/notice/**",           // 校园公告公开浏览
                            "/api/web/auth/login",          // PC端登录
                            "/api/web/auth/login-types",    // PC端支持的登录方式
                            "/api/web/groupbuy/goods",      // 拼团商品列表（公开）
                            "/api/web/groupbuy/goods/**",   // 拼团商品详情（公开）
                            "/api/web/groupbuy/activity/**",// 拼团活动详情（公开）
                            "/api/web/groupbuy/team/**",    // 拼团组队进度（公开，供分享链接查看）
