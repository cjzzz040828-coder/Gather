...
public class PayServiceFactory {
     ...
     * 按金额创建支付订单（默认走模拟支付通道）
     */
    public Map<String, String> createPayOrder(String outTradeNo, java.math.BigDecimal amount, String subject) {
        return createPayOrder("mock", outTradeNo, amount, subject);
    }

    /**
     * 按金额创建支付订单（指定支付通道）
     */
    public Map<String, String> createPayOrder(String payType, String outTradeNo, java.math.BigDecimal amount, String subject) {
        return getService(payType).createPayOrder(outTradeNo, amount, subject);
    }

    /**
     * 退款（默认走模拟支付通道）
     */
    public Map<String, String> refund(String outTradeNo, java.math.BigDecimal amount) {
        return refund("mock", outTradeNo, amount);
    }

    /**
     * 退款（指定支付通道）
     */
    public Map<String, String> refund(String payType, String outTradeNo, java.math.BigDecimal amount) {
        return getService(payType).refund(outTradeNo, amount);
    }
